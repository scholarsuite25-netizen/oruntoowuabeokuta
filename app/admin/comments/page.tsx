              ...
              <div key={comment.id} className={`comment-card comment-${comment.status}`}>
                ...
                <div className="comment-actions">
                  {comment.status !== "approved" && (
                    <button onClick={() => updateStatus(comment.id, "approved")} className="link-btn link-btn-approve">
                      Approve
                    </button>
                  )}
                  {comment.status !== "rejected" && (
                    <button onClick={() => updateStatus(comment.id, "rejected")} className="link-btn">
                      Reject
                    </button>
                  )}
                  <button onClick={() => deleteComment(comment.id)} className="link-btn link-btn-danger">
                    Delete
                  </button>
                </div>
              </div>
